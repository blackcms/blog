    ...
    public function up()
    {
        if (!Schema::hasTable("posts_translations")) {
            Schema::create("posts_translations", function (Blueprint $table) {
                ...
                $table->primary(
                    ["lang_code", "posts_id"],
                    "posts_translations_primary"
                );
            });
        }

        if (!Schema::hasTable("categories_translations")) {
            Schema::create("categories_translations", function (
                Blueprint $table
            ) {
                $table->string("lang_code");
                ...
                $table->primary(
                    ["lang_code", "categories_id"],
                    "categories_translations_primary"
                );
            });
        }

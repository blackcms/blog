...
use BlackCMS\Base\Supports\SortItemsWithChildrenHelper;
...
use BlackCMS\Blog\Supports\PostFormat;
...
if (!function_exists("get_latest_posts")) {
    ...
    function get_latest_posts(
        ...
        return app(PostInterface::class)->getListPostNonInList(
            $excepts,
            $limit,
            $with
        );
...
if (!function_exists("get_posts_by_category")) {
    ...
    function get_posts_by_category(
        ...
        return app(PostInterface::class)->getByCategory(
            $categoryId,
            $paginate,
            $limit
        );
...
if (!function_exists("get_featured_categories")) {
    ...
    {
        return app(CategoryInterface::class)->getFeaturedCategories(
            $limit,
            $with
        );
    }
...
if (!function_exists("get_all_categories")) {
    ...
    {
        return app(CategoryInterface::class)->getAllCategories(
            $condition,
            $with
        );
    }
...
if (!function_exists("get_popular_tags")) {
    ...
    function get_popular_tags(
        ...
        return app(TagInterface::class)->getPopularTags(
            $limit,
            $with,
            $withCount
        );
...
if (!function_exists("get_popular_categories")) {
    ...
    function get_popular_categories(
        ...
        return app(CategoryInterface::class)->getPopularCategories(
            $limit,
            $with,
            $withCount
        );
...
if (!function_exists("get_blog_page_url")) {
    ...
    function get_blog_page_url(): string
    {
        ...
        $blogPage = app(
            \BlackCMS\Page\Repositories\Interfaces\PageInterface::class
        )->findById($blogPageId);

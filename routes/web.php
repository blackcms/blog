...
Route::group(
    ...
    function () {
        Route::group(
            [
                "prefix" => BaseHelper::getAdminPrefix() . "/blog",
                "middleware" => "auth",
            ],
            function () {
                Route::group(
                ...
                Route::group(
                    ["prefix" => "tags", "as" => "tags."],
                    function () {
                        Route::resource("", "TagController")->parameters([
                            "" => "tag",
                        ]);
            ...
            Route::group(
                ...
                function () {
                    ...
                    if (SlugHelper::getPrefix(Tag::class, "tag")) {
                        Route::get(
                            SlugHelper::getPrefix(Tag::class, "tag") .
                                "/{slug}",
                            [
                                "as" => "public.tag",
                    ...
                    if (SlugHelper::getPrefix(Post::class)) {
                        Route::get(
                            SlugHelper::getPrefix(Post::class) . "/{slug}",
                            [
                    ...
                    if (SlugHelper::getPrefix(Category::class)) {
                        Route::get(
                            SlugHelper::getPrefix(Category::class) . "/{slug}",
                            [

...
class PostTable extends TableAbstract
{
    ...
    public function columns()
    {
        return [
            ...
            "updated_at" => [
                "title" => trans("addons/blog::posts.categories"),
                "width" => "150px",
                "class" => "no-sort text-center",
                "orderable" => false,
            ],
            "author_id" => [
                "title" => trans("addons/blog::posts.author"),
                "width" => "150px",
                "class" => "no-sort text-center",
                "orderable" => false,
            ],
    ...
    public function getBulkChanges(): array
    {
        return [
            ...
            "status" => [
                ...
                "validate" =>
                    "required|in:" . implode(",", BaseStatusEnum::values()),
            ],
            "category" => [
                "title" => trans("addons/blog::posts.category"),
                "type" => "select-search",
                "validate" => "required",
     ...
     * {@inheritDoc}
     */
    public function saveBulkChangeItem(
        $item,
        string $inputKey,
        ?string $inputValue
    ) {

...
use BlackCMS\Blog\Forms\CategoryForm;
use BlackCMS\Blog\Models\Category;
use BlackCMS\Blog\Http\Requests\CategoryRequest;
...
class CategoryController extends BaseController
{
    ...
    public function index(
        ...
        page_title()->setTitle(trans("addons/blog::categories.menu"));
        ...
        Assets::addStylesDirectly([
            "vendor/core/core/base/css/tree-category.css",
        ])->addScriptsDirectly(["vendor/core/core/base/js/tree-category.js"]);

        $form = $formBuilder->create(CategoryForm::class, [
            "template" => "core/base::forms.form-tree-category",
        ]);
    ...
    public function create(
        ...
        page_title()->setTitle(trans("addons/blog::categories.create"));
    ...
    public function store(CategoryRequest $request, BaseHttpResponse $response)
    {
        ...
        event(
            new CreatedContentEvent(CATEGORY_MODULE_NAME, $request, $category)
        );
    ...
    public function edit(
        ...
        page_title()->setTitle(
            trans("addons/blog::categories.edit") . ' "' . $category->name . '"'
        );

        return $formBuilder
            ->create(CategoryForm::class, ["model" => $category])
            ->renderForm();
    }
    ...
    public function update(
        ...
        event(
            new UpdatedContentEvent(CATEGORY_MODULE_NAME, $request, $category)
        );
    ...
    protected function getOptions($options = [])
    {
        return array_merge(
            [
                ...
                "canDelete" => Auth::user()->hasPermission(
                    "categories.destroy"
                ),

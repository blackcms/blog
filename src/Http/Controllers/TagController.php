...
class TagController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans("addons/blog::tags.menu"));
    ...
    {
        page_title()->setTitle(trans("addons/blog::tags.create"));
    ...
    public function store(TagRequest $request, BaseHttpResponse $response)
    {
        ...
        event(new CreatedContentEvent(TAG_MODULE_NAME, $request, $tag));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(
            trans("addons/blog::tags.edit") . ' "' . $tag->name . '"'
        );

        return $formBuilder
            ->create(TagForm::class, ["model" => $tag])
            ->renderForm();
    }
    ...
    public function update($id, TagRequest $request, BaseHttpResponse $response)
    {
        ...
        event(new UpdatedContentEvent(TAG_MODULE_NAME, $request, $tag));
    ...
    public function destroy($id, Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            event(new DeletedContentEvent(TAG_MODULE_NAME, $request, $tag));

            return $response->setMessage(trans("addons/blog::tags.deleted"));
        } catch (Exception $exception) {
            return $response
                ->setError()
                ->setMessage(trans("addons/blog::tags.cannot_delete"));
        }
    }

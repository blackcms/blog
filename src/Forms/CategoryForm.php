...
class CategoryForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $categories =
            [0 => trans("addons/blog::categories.none")] + $categories;

        $this->setupModel(new Category())
            ...
            ->add("icon", "text", [
                ...
                "label_attr" => ["class" => "control-label"],
                "attr" => [
                    "placeholder" => "Ex: las la-home la-2x",
                    "data-counter" => 60,
                ],
            ])
            ->add("order", "number", [
                ...
                "attr" => [
                    "placeholder" => trans(
                        "core/base::forms.order_by_placeholder"
                    ),
                ],
                "default_value" => 0,
            ])
